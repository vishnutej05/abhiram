...
const VSLSection = () => {
  return (
    <section id="vsl" className="py-20 bg-gradient-to-br from-gray-900 via-gray-800 to-black relative overflow-hidden">
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="relative max-w-5xl mx-auto mb-12">
          <div className="aspect-video rounded-3xl overflow-hidden shadow-2xl border-4 border-gray-700">
            <iframe
              width="100%"
              height="100%"
